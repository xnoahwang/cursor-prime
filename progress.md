...
## Current Focus
- Block: v2.0.1 release
- Status: 100%

## Completed
- v2.0: Task class, Explore cheap, Session continuity, Handoff, `/verify`, optional hooks
- v2.0.1: Stricter task class (docs/file edits always non-trivial)
- README Testing section, Changelog, AGENTS.md sync

## Next Steps
1. Users on v2.0: `git pull` then `install.ps1 -Force` and re-paste User Rules
