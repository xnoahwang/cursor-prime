...
.EXAMPLE
    & "$env:USERPROFILE\cursor-prime\init.ps1" -Force
#>
[CmdletBinding()]
param(
    [switch]$Force
...
Log "Done in: $Target"
Log "Open a new chat here and ask for a non-trivial task; the agent should output a plan block and wait for GO."
