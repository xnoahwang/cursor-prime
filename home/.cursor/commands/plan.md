...
- **Done when** — the verifiable stop condition; the task is incomplete until this is met. Must bind to executable verify command(s) when a hard gate exists (test, lint, build, typecheck).
